...
<div class="container">
	...
	<form method="post" action="/member/memberEditOk" id="mFrm">
		<ul>
			...
			<li>연락처</li>
			<li>
			<input type="text" name="tel1" id="tel1" size="4" value="${vo.tel1}"/>
			<input type="text" name="tel2" id="tel2" size="4" value="${vo.tel2}"/>
			<input type="text"	name="tel3" id="tel3" size="4" value="${vo.tel3}"/>
			</li>
			<li>이메일</li>
			<li><input type="text" name="email" id="email" value="${vo.email}"/></li>
			<li>우편번호</li>
			<li><input type="text" name="zipcode" id="zipcode" value="${vo.zipcode}" /> <input
			...
			<li><input type="submit" value="회원정보 수정하기" /><br /> <input
