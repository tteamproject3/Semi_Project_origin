...
public class maps {
    public static void main(String[] args) throws IOException {
         ...
         urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=k%2BXUC8ZGTgciDc7GQP6q9XAd2Bd9IX5sbFqouotvyi4IQP2S%2BHFsLpGOxgYjnAlGImd%2FeNjPFPBu8xlS%2BhCLKw%3D%3D"); /*Service Key*/
