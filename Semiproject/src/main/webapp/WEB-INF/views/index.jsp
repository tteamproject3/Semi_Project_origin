		...
		<section class="theme">
			...
			<ul class="theme__list">
				<li>
					<!-- theme card -->
					<div class="card">
						<img src="img/nightsky-view.jpg" alt="" width="10%">
					...
					<!-- theme description -->
					<div class="descript">
						<span class="desc__title">한옥 카페 시리즈</span>
			...
			<ul class="festival__list">
				...
				<li>
					<div class="festival__info">
						<!-- festival info -->
						<img src="img/city-view.jpg" alt="" width="10%">
						<i class="fa-regular fa-heart">2022 목포문화재야행</i>
						<span class="festival__title">전라남도 목포시</span>
						<span class="festival__detail">2022. 7. 29. ~ 30. / 18:00 ~ 22:00</span>
					</div>
				</li>
				<li></li>
				<li></li>
