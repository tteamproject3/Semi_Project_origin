...
<section class = "container">
	<div class="cBox">
		...
		<ul>
			...
			<li>사이드 제목</li>
			<li><input type = "text" name="post_intro" id = "post_intro" style="width:100%"/></li>
			<li>구분</li>
			<li><select name="post_type" id="post_type" style="width:100%">
				<option value="theme">테마여행</option>
			</select></li>
			<li>이미지파일</li>
			<li><input type = "text" name="post_file1" id = "post_file1" style="width:100%"/></li>
